...
# querey parameters 
router.get('/all', summary='Retrieve all blogs', description='This API calls simulates retrieving all blogs')
...
@router.get('/type/{type}', summary='Retreives all blogs of specific type')
...
@router.get('/{id}', status_code=status.HTTP_200_OK, response_description='Responds with a specific blog' )
